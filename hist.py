...
def hist_tab(data):
    ...
    def make_data(s_data, rs=-60, re=120, bin=10):
    ...
    def update(attr, old, new):
        ...
        data_source = make_data(air_lines_checked, range_slider.value[0], range_slider.value[1], slider.value)
        src.data.update(data_source.data)
    ...
    src = make_data(init_data)
    p = make_plot(src)

    widget = WidgetBox(chbox, slider, range_slider)
    l = row(widget, p)
